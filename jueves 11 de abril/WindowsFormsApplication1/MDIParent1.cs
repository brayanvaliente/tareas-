...
namespace WindowsFormsApplication1
{
    public partial class MDIParent1 : Form
    {
        ...
        private void abritToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            Form2 hijo1 = new Form2();
            hijo1.MdiParent = this;

            hijo1.Show(); 
        }

        private void guaardarToolStripMenuItem_Click(object sender, EventArgs e)
        {
